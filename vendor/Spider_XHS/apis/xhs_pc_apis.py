...
class XHS_Apis():
    ...
    def get_note_info(self, url: str, cookies_str: str, proxies: dict = None):
        ...
        try:
            ...
            # 处理 SSL 错误，添加 verify=False 参数
            response = requests.post(self.base_url + api, headers=headers, data=data, cookies=cookies, proxies=proxies, verify=False)
            res_json = response.json()
            success, msg = res_json["success"], res_json["msg"]
        except Exception as e:
            success = False
...
if __name__ == '__main__':
    ...
    cookies_str = r''
    # 获取用户信息
    user_url = 'https://www.xiaohongshu.com/user/profile/USER_ID?xsec_token=TOKEN&xsec_source=pc_feed'
    ...
    # 获取笔记信息
    note_url = r'https://www.xiaohongshu.com/explore/NOTE_ID?xsec_token=TOKEN&xsec_source=pc_user'
